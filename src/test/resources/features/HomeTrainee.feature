...
Feature: Home for Trainees features
  ...
  Scenario: Trainee sees correct details on the Home Trainee Page
    ...
    Then I can see my Trainee details

  Scenario: Trainee sees correct Grade for previous week on the Home Trainee Page
    Given I am logged in as a trainee and on the Home Trainee Page
    When I am on the Home Trainee Page
    Then I can see my Grade for previous week

  Scenario: Trainee goes to Weekly Attendance from the Home Trainee Page
    Given I am logged in as a trainee and on the Home Trainee Page
  ...
  Scenario: Trainee goes to Trainee Report from the Home Trainee Page
    Given I am logged in as a trainee and on the Home Trainee Page
  ...
  Scenario: Trainee goes to Home Trainee Page from the Home Trainee Page (Logo)
    Given I am logged in as a trainee and on the Home Trainee Page
  ...
  Scenario: Trainee goes to Home Trainee Page from the Home Trainee Page (Profile)
    Given I am logged in as a trainee and on the Home Trainee Page
  ...
  Scenario: Trainee goes to Feedback Form Page from the Home Trainee Page
    Given I am logged in as a trainee and on the Home Trainee Page
  ...
  Scenario: Trainee goes to Report Trainee Page from the Home Trainee Page
    Given I am logged in as a trainee and on the Home Trainee Page
    When I click Trainee Options on the trainee sidebar on the Home Trainee Page
  ...
  Scenario: Trainee goes to Add Weeks Page from the Home Trainee Page
    Given I am logged in as a trainee and on the Home Trainee Page
    When I click Trainee Options on the trainee sidebar on the Home Trainee Page
    And I click on Add Weeks on the Home Trainee Page
    Then I am taken to the Add Weeks Page from the Home Trainee Page
