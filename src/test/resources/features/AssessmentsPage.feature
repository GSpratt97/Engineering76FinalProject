...
Feature: Actions on the Assessments Page
  ...
  @AssessmentsDone
  Scenario: Trainer goes to Trainee Guide page from Assessments page
    Given I am logged in as a trainer and on the Assessments Page
    When I click View on the trainer sidebar on the Assessments Page
  ...
  @AssessmentsDone
  Scenario: Trainer goes to Class Management page from Assessments page
    Given I am logged in as a trainer and on the Assessments Page
  ...
  @AssessmentsDone
  Scenario: Trainer goes to Manage Trainee page from Assessments page
    Given I am logged in as a trainer and on the Assessments Page
    When I click Trainer Options on the trainer sidebar on the Assessments Page
  ...
  @AssessmentsDone
  Scenario: Trainer goes to Add Weeks page from Assessments page
    Given I am logged in as a trainer and on the Assessments Page
    When I click Trainer Options on the trainer sidebar on the Assessments Page
  ...
  @AssessmentsDone
  Scenario: Trainer goes to Assessments page from Assessments page
    Given I am logged in as a trainer and on the Assessments Page
    When I click Trainer Options on the trainer sidebar on the Assessments Page
  ...
  @AssessmentsDone
  Scenario: Trainer goes to Enter Attendance page from Assessments page
    Given I am logged in as a trainer and on the Assessments Page
    When I click Trainer Options on the trainer sidebar on the Assessments Page
  ...
  @AssessmentsDone
  Scenario: Trainer goes to Weekly Attendance page from Assessments page
    Given I am logged in as a trainer and on the Assessments Page
    When I click Trainer Options on the trainer sidebar on the Assessments Page
